...
export function SiteFooter() {
	return (
		<footer className="mt-16 border-t border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800">
			<div className="max-w-full lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 text-center">
				...
				<p className="text-xs text-park-stone dark:text-stone-400 mt-1.5">
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						className="inline-flex items-center gap-1 text-park-forest hover:underline font-medium"
						aria-label="ParkReach on GitHub"
					>
